...
define("config", ["require", "exports", "dotenv"], function (require, exports, dotenv_1) {
    "use strict";
...
define("api/releases", ["require", "exports", "ramda", "config"], function (require, exports, R, config_1) {
    "use strict";
    var _this = this;
    exports.__esModule = true;
    exports.npmConf = function () { return ({
        registry: config_1["default"].NPM_REGISTRY
    }); };
    exports.typeIsAlpha = R.compose(R.equals("alpha"), R.prop("type"));
    exports.typeIsBeta = R.compose(R.equals("beta"), R.prop("type"));
    exports.typeIsRelease = function (x) { return !exports.typeIsAlpha(x) && !exports.typeIsBeta(x); };
    exports.isCreatedOrModified = function (x) { return x === "created" || x === "modified"; };
...
define("utils", ["require", "exports", "ramda", "config"], function (require, exports, R, config_2) {
    "use strict";
    exports.__esModule = true;
    exports.paramsToQuery = R.compose(R.join(""), R.ifElse(R.equals(1), R.prepend("?"), R.always([])), R.join("&"), R.map(R.join("=")), R.toPairs);
    exports.headers = R.compose(R.assocPath(["headers", "common", "Authorization"], R.__, {}), R.concat("Basic "));
    exports.buildCredentials = function (username, password) {
        return Buffer.from(username + ":" + password, "ascii").toString("base64");
    };
    exports.branchesUrl = function (project, repo) {
        return R.compose(R.replace("%project%", project), R.replace("%repo%", repo))(config_2["default"].BRANCHES_URL);
    };
    exports.commitsUrl = function (project, repo, _a) {
        var limit = _a.limit;
        return R.compose(R.flip(R.concat)(exports.paramsToQuery({ limit: limit })), R.replace("%project%", project), R.replace("%repo%", repo))(config_2["default"].COMMITS_URL);
    };
});
define("resolvers", ["require", "exports", "api/branches", "api/commits", "api/releases", "utils"], function (require, exports, Branches, Commits, Releases, utils_1) {
    "use strict";
    exports.__esModule = true;
    exports.resolvers = function (npm, axios) { return ({
        Query: {
...
define("app", ["require", "exports", "cors", "express", "express-graphql", "config", "schema", "utils", "routes"], function (require, exports, cors_1, express, express_graphql_1, config_4, schema_1, utils_3, routes) {
    "use strict";
    exports.__esModule = true;
    var app = express();
    ...
    app.options("/graphql", cors_1["default"]());
